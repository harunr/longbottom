...
calcWinsize()   
    ...
    window.addEventListener('load', calcWinsize);
    ...
    class SmoothScroll {
        constructor() {
            // the <main> element
            this.DOM = {main: document.querySelector('.viewport')};
            // the scrollable element
            // we translate this element when scrolling (y-axis)
            this.DOM.scrollable = this.DOM.main.querySelector('#scroll-container');
            // the items on the page
            this.items = [];
            [...this.DOM.main.querySelectorAll('.item-box')].forEach(item => this.items.push(new Item(item)));
